...
export const TRACK_META = {
  ...
  "data-and-design": {
    ...
    description: "The first current lectures from BinaryTree’s new dual-track program in data architecture and visual communication.",
...
export function getTracks() {
  ...
  return Array.from(grouped.entries()).map(([slug, lessons]) => ({
    ...
    ...(TRACK_META[slug] || {
      ...
      description: "A BinaryTree learning track.",
