      ...
      <section className="home-section">
        <div className="container">
          ...
          <div className="tool-grid">
            ...
            <article className="tool-card" data-reveal><h2>Offline study materials</h2><p>Detailed lesson notes, six flashcards, and six instant-feedback questions per lesson are prepared on the first visit so students can continue after the network drops.</p><Link className="button button-secondary" href="/study">Preview study tools</Link></article>
            <article className="tool-card" data-reveal><h2>Translation review workflow</h2><p>A language switcher shows one English, Kiswahili, or French overview at a time. Every unreviewed draft stays clearly marked before formal approval.</p><Link className="button button-secondary" href="/learn">Review curriculum</Link></article>
          </div>
        </div>
      </section>
    </main>
