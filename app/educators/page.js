...
export const metadata = {
  title: "For educators",
  description: "Low-resource teaching tools, offline curriculum, and a ready-to-teach lesson-plan generator from BinaryTree.",
};
      ...
      <section className="educator-hero">
        <div className="container educator-hero-grid" data-reveal>
          <div>
            ...
            <p>BinaryTree turns the current curriculum into dependable offline lesson notes and gives instructors a practical planning tool for classrooms with shared devices, limited materials, and inconsistent connectivity.</p>
