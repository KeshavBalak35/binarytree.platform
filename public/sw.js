const CACHE_VERSION = "binarytree-v2-2026-07-25";
const CORE_ROUTES = ["/", "/learn", "/study", "/educators", "/educators/lesson-planner", "/about", "/offline", "/manifest.webmanifest", "/app-icon.svg", "/btlogo.png"];
