...
level: "Intermediate"
duration: 75
sourceUrl: "https://docs.google.com/presentation/d/1Na2qrUMFi3XpOOXx0rachPoL_97SJHR8/edit"
...
objectives: ["Explain File mode in your own words.","Apply CSV to a realistic classroom or community example.","Connect File mode with JSON when making a decision.","Complete the practice task and reflect on one improvement."]
keyIdeas: [{"term":"File mode","definition":"The instruction passed to open—such as read, write, or append—that determines what operations are allowed and whether existing content is preserved."},{"term":"CSV","definition":"A plain-text format for flat rows and columns that is easy to exchange with spreadsheets but stores values as text."},{"term":"JSON","definition":"A text format that preserves nested objects, arrays, numbers, booleans, and text for structured data exchange."}]
flashcards: [{"front":"File mode","back":"The instruction passed to open—such as read, write, or append—that determines what operations are allowed and whether existing content is preserved."},{"front":"CSV","back":"A plain-text format for flat rows and columns that is easy to exchange with spreadsheets but stores values as text."},{"front":"JSON","back":"A text format that preserves nested objects, arrays, numbers, booleans, and text for structured data exchange."},{"front":"Why this lesson matters","back":"Read and write files safely, choose CSV for flat tables and JSON for structured data, and use context managers and libraries to avoid data loss."},{"front":"Practice challenge","back":"Load a small CSV of community resources, calculate a count by category, and save a JSON summary. Handle a missing file without crashing the program."},{"front":"Teach it back","back":"Explain File mode, show how CSV is used, and describe why JSON changes the result."}]
quiz: [{"question":"Which explanation best describes File mode?","choices":["The instruction passed to open—such as read, write, or append—that determines what operations are allowed and whether existing content is preserved.","A plain-text format for flat rows and columns that is easy to exchange with spreadsheets but stores values as text.","A text format that preserves nested objects, arrays, numbers, booleans, and text for structured data exchange.","A decorative feature with no effect on the task"],"answer":0,"explanation":"The instruction passed to open—such as read, write, or append—that determines what operations are allowed and whether existing content is preserved."},{"question":"Which explanation best describes CSV?","choices":["The instruction passed to open—such as read, write, or append—that determines what operations are allowed and whether existing content is preserved.","A text format that preserves nested objects, arrays, numbers, booleans, and text for structured data exchange.","A decorative feature with no effect on the task","A plain-text format for flat rows and columns that is easy to exchange with spreadsheets but stores values as text."],"answer":3,"explanation":"A plain-text format for flat rows and columns that is easy to exchange with spreadsheets but stores values as text."},{"question":"Which explanation best describes JSON?","choices":["A plain-text format for flat rows and columns that is easy to exchange with spreadsheets but stores values as text.","A decorative feature with no effect on the task","A text format that preserves nested objects, arrays, numbers, booleans, and text for structured data exchange.","The instruction passed to open—such as read, write, or append—that determines what operations are allowed and whether existing content is preserved."],"answer":2,"explanation":"A text format that preserves nested objects, arrays, numbers, booleans, and text for structured data exchange."},{"question":"Which action best applies CSV in this lesson?","choices":["Load a small CSV of community resources, calculate a count by category, and save a JSON summary. Handle a missing file without crashing the program.","Skip the goal and begin clicking until something changes.","Copy another learner’s result without explaining the steps.","Memorize the term but avoid using it in a realistic task."],"answer":0,"explanation":"The guided practice applies CSV through a concrete task: Load a small CSV of community resources, calculate a count by category, and save a JSON summary. Handle a missing file without crashing the program."},{"question":"How do File mode and JSON work together?","choices":["They are unrelated terms that should be studied separately.","JSON replaces the need to understand File mode.","File mode gives you a foundation, while JSON helps you make a safer or more effective decision during the task.","They only matter when every learner has a separate computer."],"answer":2,"explanation":"Connecting File mode with JSON turns a definition into a decision you can explain and check."},{"question":"What is the strongest evidence that you understood this lesson?","choices":["Reading the title once and moving on.","Completing the practice, comparing the result with your prediction, and explaining one improvement.","Finishing before everyone else without checking the result.","Remembering one word but not being able to use it."],"answer":1,"explanation":"Real understanding combines action, checking, explanation, and reflection—not speed or memorization alone."}]
